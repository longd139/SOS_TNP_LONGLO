  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(loginUser.fulfilled, (state, action) => {
        ...
        state.requiresTwoFactorAuth =
          action.payload.requiresTwoFactorAuth || false;
...
export const { clearErrors, clearChangePasswordSuccess, logout, restoreUser } =
  authSlice.actions;
