...
export default function SatisfactionDashboard() {
  ...
  const ratings = useMemo(() => {
    ...
    submittedRatings.forEach((item) => byCode.set(item.code, item));
  ...
  return <main className="satisfaction-dashboard pb-10 bg-gray-50 min-h-screen">
    <div className="max-w-7xl mx-auto">
      ...
      <ComplaintDetailModal code={selectedComplaintCode} onClose={() => setSelectedComplaintCode(null)} />
    </div>
  </main>;
}
