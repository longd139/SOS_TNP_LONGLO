      ...
      >
        ...
        >
          {(title || showCloseButton) && (
            <div
              className="bg-white px-3 md:px-4 py-3 border-b border-gray-200"
              style={{
          ...
          {footer && (
            <div
              className="bg-gray-50 px-3 py-2 sm:px-4 sm:flex sm:flex-row-reverse border-t border-gray-200"
              style={{
