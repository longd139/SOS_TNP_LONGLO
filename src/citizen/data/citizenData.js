...
export const libraryDocuments = [
  { id: 'sach-01', category: 'tu-sach', title: 'Lịch Sử Phường Tăng Nhơn Phú Qua Các Thời Kỳ', author: 'Ban Văn hóa Phường', cover: 'https://picsum.photos/seed/book1/600/400', description: 'Tìm hiểu về lịch sử hình thành, phát triển và những dấu mốc quan trọng của phường Tăng Nhơn Phú từ thời kỳ khai hoang đến nay.', downloads: 3842, featured: true, docType: 'Sách', tags: ['lịch sử', 'địa phương', 'văn hóa'],
    sections: [
  ...
  { id: 'sach-03', category: 'tu-sach', title: 'Chuyện Kể Về Những Người Anh Hùng Địa Phương', author: 'Hội Cựu Chiến binh', cover: 'https://picsum.photos/seed/book3/600/400', description: 'Tập hợp những câu chuyện cảm động về các anh hùng, liệt sĩ xuất thân từ địa phương.', downloads: 5621, featured: true, docType: 'Sách', tags: ['lịch sử', 'anh hùng', 'địa phương'],
    sections: [
  ...
  { id: 'sach-04', category: 'tu-sach', title: 'Truyện Cổ Tích Cho Thiếu Nhi - Tập 1', author: 'Thư viện Cộng đồng', cover: 'https://picsum.photos/seed/book4/600/400', description: 'Tuyển tập các truyện cổ tích, ngụ ngôn giúp các em thiếu nhi nuôi dưỡng trí tưởng tượng.', downloads: 12340, featured: false, docType: 'Sách', tags: ['thiếu nhi', 'truyện', 'giáo dục'] },
  { id: 'sach-05', category: 'tu-sach', title: 'Kỹ Năng Số Cho Người Cao Tuổi', author: 'Hội Người Cao tuổi', cover: 'https://picsum.photos/seed/book5/600/400', description: 'Hướng dẫn sử dụng điện thoại thông minh, mạng xã hội và các ứng dụng hữu ích.', downloads: 8750, featured: false, docType: 'Sách', tags: ['người cao tuổi', 'công nghệ', 'kỹ năng số'] },

  { id: 'tl-01', category: 'tai-lieu', title: 'Hướng Dẫn Đăng Ký Tài Khoản Dịch Vụ Công Trực Tuyến', author: 'Bộ phận Một cửa', cover: 'https://picsum.photos/seed/doc1/600/400', description: 'Các bước đăng ký, xác thực tài khoản và sử dụng cổng dịch vụ công trực tuyến từ A đến Z.', downloads: 15230, featured: true, docType: 'Tài liệu hướng dẫn', tags: ['dịch vụ công', 'trực tuyến', 'hướng dẫn'],
    sections: [
  ...
  { id: 'tl-03', category: 'tai-lieu', title: 'Sổ Tay Sức Khỏe Gia Đình: Phòng Bệnh Mùa Mưa', author: 'Trạm Y tế Phường', cover: 'https://picsum.photos/seed/doc3/600/400', description: 'Hướng dẫn phòng chống các bệnh thường gặp trong mùa mưa: sốt xuất huyết, cảm cúm, tiêu chảy.', downloads: 14200, featured: false, docType: 'Tài liệu hướng dẫn', tags: ['sức khỏe', 'phòng bệnh', 'gia đình'] },
  { id: 'tl-04', category: 'tai-lieu', title: 'Hướng Dẫn Làm Hồ Sơ Xin Việc Cho Thanh Niên Địa Phương', author: 'Đoàn Thanh niên', cover: 'https://picsum.photos/seed/doc4/600/400', description: 'Kỹ năng viết CV, thư xin việc và chuẩn bị phỏng vấn cho thanh niên mới ra trường.', downloads: 6230, featured: false, docType: 'Tài liệu hướng dẫn', tags: ['việc làm', 'thanh niên', 'kỹ năng'] },
  { id: 'tl-05', category: 'tai-lieu', title: 'Cẩm Nang An Toàn Giao Thông Cho Học Sinh', author: 'Công an Phường', cover: 'https://picsum.photos/seed/doc5/600/400', description: 'Luật giao thông cơ bản, biển báo thường gặp và kỹ năng tham gia giao thông an toàn.', downloads: 18900, featured: false, docType: 'Tài liệu hướng dẫn', tags: ['giao thông', 'an toàn', 'học sinh'] },

  { id: 'vb-01', category: 'van-ban', title: 'Quy Định Về Quản Lý Trật Tự Đô Thị Trên Địa Bàn Phường', author: 'UBND Phường Tăng Nhơn Phú', cover: 'https://picsum.photos/seed/law1/600/400', description: 'Tổng hợp các quy định về trật tự xây dựng, lấn chiếm vỉa hè, lòng lề đường và xử phạt hành chính.', downloads: 5670, featured: true, docType: 'Văn bản pháp luật', issuingAgency: 'UBND Phường Tăng Nhơn Phú', issuedDate: '15/06/2025', effectiveDate: '01/07/2025', status: 'Đang hiệu lực', content: 'Nội dung chi tiết về quy định quản lý trật tự đô thị...', tags: ['trật tự đô thị', 'xây dựng', 'xử phạt'] },
  { id: 'vb-02', category: 'van-ban', title: 'Thông Tư Hướng Dẫn Thực Hiện Dân Chủ Cơ Sở', author: 'Bộ Nội vụ', cover: 'https://picsum.photos/seed/law2/600/400', description: 'Quy chế thực hiện dân chủ ở xã, phường, thị trấn và quyền tham gia của người dân vào hoạt động quản lý nhà nước.', downloads: 3420, featured: false, docType: 'Văn bản pháp luật', issuingAgency: 'Bộ Nội vụ', issuedDate: '10/04/2025', effectiveDate: '01/06/2025', status: 'Đang hiệu lực', content: 'Nội dung chi tiết về thực hiện dân chủ cơ sở...', tags: ['dân chủ', 'cơ sở', 'quyền dân sự'] },
  { id: 'vb-03', category: 'van-ban', title: 'Nghị Định Về Xử Phạt Vi Phạm Hành Chính Trong Lĩnh Vực Đất Đai', author: 'Chính phủ', cover: 'https://picsum.photos/seed/law3/600/400', description: 'Quy định mức phạt và biện pháp khắc phục đối với các hành vi vi phạm hành chính về đất đai.', downloads: 7890, featured: false, docType: 'Văn bản pháp luật', issuingAgency: 'Chính phủ', issuedDate: '20/03/2025', effectiveDate: '15/05/2025', status: 'Đang hiệu lực', content: 'Nội dung chi tiết về xử phạt vi phạm đất đai...', tags: ['đất đai', 'xử phạt', 'vi phạm'] },
  { id: 'vb-04', category: 'van-ban', title: 'Quyết Định Ban Hành Quy Chế Tiếp Công Dân Tại UBND Phường', author: 'UBND Phường Tăng Nhơn Phú', cover: 'https://picsum.photos/seed/law4/600/400', description: 'Quy trình, thời gian và trách nhiệm tiếp nhận, xử lý kiến nghị của công dân tại trụ sở UBND phường.', downloads: 4560, featured: false, docType: 'Văn bản pháp luật', issuingAgency: 'UBND Phường Tăng Nhơn Phú', issuedDate: '01/01/2025', effectiveDate: '15/01/2025', status: 'Đang hiệu lực', content: 'Nội dung chi tiết về quy chế tiếp công dân...', tags: ['tiếp dân', 'quy chế', 'khiếu nại'] },
  { id: 'vb-05', category: 'van-ban', title: 'Luật Cư Trú Số 68/2020/QH14', author: 'Quốc hội', cover: 'https://picsum.photos/seed/law5/600/400', description: 'Quy định về quyền tự do cư trú, đăng ký và quản lý cư trú của công dân Việt Nam.', downloads: 12450, featured: true, docType: 'Văn bản pháp luật', issuingAgency: 'Quốc hội', issuedDate: '13/11/2020', effectiveDate: '01/07/2021', status: 'Đang hiệu lực', content: 'Luật này quy định về quyền tự do cư trú của công dân...', tags: ['cư trú', 'luật', 'quyền công dân'] },
  { id: 'vb-06', category: 'van-ban', title: 'Nghị Định 144/2021/NĐ-CP Về Xử Phạt An Ninh Trật Tự', author: 'Chính phủ', cover: 'https://picsum.photos/seed/law6/600/400', description: 'Quy định xử phạt vi phạm hành chính trong lĩnh vực an ninh, trật tự, an toàn xã hội.', downloads: 9870, featured: false, docType: 'Văn bản pháp luật', issuingAgency: 'Chính phủ', issuedDate: '31/12/2021', effectiveDate: '01/02/2022', status: 'Đang hiệu lực', content: 'Nội dung chi tiết về xử phạt an ninh trật tự...', tags: ['an ninh', 'trật tự', 'xử phạt'] },
  { id: 'vb-07', category: 'van-ban', title: 'Luật Hôn Nhân Và Gia Đình 2014 (Trích Yếu)', author: 'Quốc hội', cover: 'https://picsum.photos/seed/law7/600/400', description: 'Trích yếu các điều khoản quan trọng về kết hôn, ly hôn, quyền và nghĩa vụ của vợ chồng.', downloads: 8900, featured: false, docType: 'Văn bản pháp luật', issuingAgency: 'Quốc hội', issuedDate: '19/06/2014', effectiveDate: '01/01/2015', status: 'Đang hiệu lực', content: 'Trích yếu Luật Hôn nhân và Gia đình...', tags: ['hôn nhân', 'gia đình', 'quyền lợi'] },

  { id: 'bd-01', category: 'ban-do', title: 'Bản Đồ Di Tích Lịch Sử Phường Tăng Nhơn Phú', author: 'Ban Văn hóa', cover: 'https://picsum.photos/seed/map1/600/400', description: 'Bản đồ chi tiết vị trí các di tích lịch sử, văn hóa được công nhận trên địa bàn phường.', downloads: 12300, featured: true, docType: 'Bản đồ', tags: ['di tích', 'lịch sử', 'bản đồ'] },
  { id: 'bd-02', category: 'ban-do', title: 'Hành Trình Khám Phá Chùa Cổ Trên Địa Bàn', author: 'Hội Di sản Văn hóa', cover: 'https://picsum.photos/seed/map2/600/400', description: 'Giới thiệu lịch sử các ngôi chùa cổ, kiến trúc độc đáo và lễ hội truyền thống.', downloads: 8760, featured: false, docType: 'Bản đồ', tags: ['chùa', 'di sản', 'văn hóa'] },
  { id: 'bd-03', category: 'ban-do', title: 'Tuyến Đường Di Sản: Dấu Chân Xưa Trên Đất Mới', author: 'Phòng Văn hóa Thông tin', cover: 'https://picsum.photos/seed/map3/600/400', description: 'Lộ trình tham quan các địa danh lịch sử, gắn với sự kiện quan trọng qua các thời kỳ.', downloads: 5100, featured: false, docType: 'Bản đồ', tags: ['du lịch', 'lịch sử', 'di sản'] },
];
