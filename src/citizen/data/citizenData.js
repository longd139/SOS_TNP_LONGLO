...
export const news = [
  { id: 'bo-phan-mot-cua', category: 'Thông báo', date: '18/07/2026', title: 'Bộ phận Một cửa mở rộng thời gian hỗ trợ hồ sơ trực tuyến', excerpt: 'Người dân có thể nhận hỗ trợ kê khai và nộp hồ sơ trực tuyến trong các khung giờ thuận tiện hơn.', image: `${process.env.PUBLIC_URL}/1.jpg` },
  { id: 'ngay-chu-nhat-xanh', category: 'Đời sống', date: '12/07/2026', title: 'Phường phát động Ngày Chủ nhật xanh tháng 7', excerpt: 'Cùng chung tay giữ gìn môi trường sống sạch đẹp tại các khu phố trên địa bàn.', image: `${process.env.PUBLIC_URL}/2.jpg` },
  { id: 'dich-vu-cong', category: 'Cải cách hành chính', date: '05/07/2026', title: 'Hướng dẫn sử dụng dịch vụ công trực tuyến toàn trình', excerpt: 'Các bước nộp hồ sơ, thanh toán lệ phí và nhận kết quả tại nhà được hướng dẫn rõ ràng.', image: `${process.env.PUBLIC_URL}/3.jpg` },
  { id: 'lich-tiep-dan', category: 'Thông báo', date: '28/06/2026', title: 'Lịch tiếp công dân định kỳ tháng 7', excerpt: 'Thông tin lịch tiếp công dân và cách đăng ký làm việc với lãnh đạo địa phương.', image: `${process.env.PUBLIC_URL}/4.jpg` },
  ...
  { id: 'cap-nhat-dia-chi', category: 'Thông báo', date: '19/06/2026', title: 'Thông báo cập nhật thông tin địa chỉ hành chính', excerpt: 'Hướng dẫn người dân sử dụng thông tin địa chỉ thống nhất trong hồ sơ và giao dịch hành chính.', image: `${process.env.PUBLIC_URL}/3.jpg` },
  { id: 'cham-soc-nguoi-cao-tuoi', category: 'Đời sống', date: '15/06/2026', title: 'Chương trình chăm sóc sức khỏe người cao tuổi', excerpt: 'Thông tin khám sức khỏe định kỳ và tư vấn chăm sóc sức khỏe cho người cao tuổi trên địa bàn.', image: `${process.env.PUBLIC_URL}/6.jpg` },
  { id: 'ho-so-truc-tuyen', category: 'Cải cách hành chính', date: '09/06/2026', title: 'Những lưu ý khi nộp hồ sơ trực tuyến', excerpt: 'Kiểm tra định dạng tệp, thông tin liên hệ và mã hồ sơ để quá trình tiếp nhận diễn ra thuận lợi.', image: `${process.env.PUBLIC_URL}/1.jpg` },
];
...
export const libraryDocuments = [
  { id: 'sach-01', category: 'tu-sach', title: 'Lịch Sử Phường Tăng Nhơn Phú Qua Các Thời Kỳ', author: 'Ban Văn hóa Phường', cover: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?auto=format&fit=crop&w=600&q=80', description: 'Tìm hiểu về lịch sử hình thành, phát triển và những dấu mốc quan trọng của phường Tăng Nhơn Phú từ thời kỳ khai hoang đến nay.', downloads: 3842, featured: true, docType: 'Sách', tags: ['lịch sử', 'địa phương', 'văn hóa'],
    sections: [
  ...
  { id: 'sach-03', category: 'tu-sach', title: 'Chuyện Kể Về Những Người Anh Hùng Địa Phương', author: 'Hội Cựu Chiến binh', cover: `${process.env.PUBLIC_URL}/4.jpg`, description: 'Tập hợp những câu chuyện cảm động về các anh hùng, liệt sĩ xuất thân từ địa phương.', downloads: 5621, featured: true, docType: 'Sách', tags: ['lịch sử', 'anh hùng', 'địa phương'],
    sections: [
  ...
  { id: 'sach-04', category: 'tu-sach', title: 'Truyện Cổ Tích Cho Thiếu Nhi - Tập 1', author: 'Thư viện Cộng đồng', cover: 'https://images.unsplash.com/photo-1512821749887-37fe6a2f01e5?auto=format&fit=crop&w=600&q=80', description: 'Tuyển tập các truyện cổ tích, ngụ ngôn giúp các em thiếu nhi nuôi dưỡng trí tưởng tượng.', downloads: 12340, featured: false, docType: 'Sách', tags: ['thiếu nhi', 'truyện', 'giáo dục'] },
  { id: 'sach-05', category: 'tu-sach', title: 'Kỹ Năng Số Cho Người Cao Tuổi', author: 'Hội Người Cao tuổi', cover: `${process.env.PUBLIC_URL}/6.jpg`, description: 'Hướng dẫn sử dụng điện thoại thông minh, mạng xã hội và các ứng dụng hữu ích.', downloads: 8750, featured: false, docType: 'Sách', tags: ['người cao tuổi', 'công nghệ', 'kỹ năng số'] },

  { id: 'tl-01', category: 'tai-lieu', title: 'Hướng Dẫn Đăng Ký Tài Khoản Dịch Vụ Công Trực Tuyến', author: 'Bộ phận Một cửa', cover: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=600&q=80', description: 'Các bước đăng ký, xác thực tài khoản và sử dụng cổng dịch vụ công trực tuyến từ A đến Z.', downloads: 15230, featured: true, docType: 'Tài liệu hướng dẫn', tags: ['dịch vụ công', 'trực tuyến', 'hướng dẫn'],
    sections: [
  ...
  { id: 'tl-03', category: 'tai-lieu', title: 'Sổ Tay Sức Khỏe Gia Đình: Phòng Bệnh Mùa Mưa', author: 'Trạm Y tế Phường', cover: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=600&q=80', description: 'Hướng dẫn phòng chống các bệnh thường gặp trong mùa mưa: sốt xuất huyết, cảm cúm, tiêu chảy.', downloads: 14200, featured: false, docType: 'Tài liệu hướng dẫn', tags: ['sức khỏe', 'phòng bệnh', 'gia đình'] },
  ...
  { id: 'tl-05', category: 'tai-lieu', title: 'Cẩm Nang An Toàn Giao Thông Cho Học Sinh', author: 'Công an Phường', cover: 'https://images.unsplash.com/photo-1449965408869-aa0e2f60d8d7?auto=format&fit=crop&w=600&q=80', description: 'Luật giao thông cơ bản, biển báo thường gặp và kỹ năng tham gia giao thông an toàn.', downloads: 18900, featured: false, docType: 'Tài liệu hướng dẫn', tags: ['giao thông', 'an toàn', 'học sinh'] },

  { id: 'vb-01', category: 'van-ban', title: 'Quy Định Về Quản Lý Trật Tự Đô Thị Trên Địa Bàn Phường', author: 'UBND Phường Tăng Nhơn Phú', cover: 'https://images.unsplash.com/photo-1477959855573-6e83a6e6e6e3?auto=format&fit=crop&w=600&q=80', description: 'Tổng hợp các quy định về trật tự xây dựng, lấn chiếm vỉa hè, lòng lề đường và xử phạt hành chính.', downloads: 5670, featured: true, docType: 'Văn bản pháp luật', issuingAgency: 'UBND Phường Tăng Nhơn Phú', issuedDate: '15/06/2025', effectiveDate: '01/07/2025', status: 'Đang hiệu lực', content: 'Nội dung chi tiết về quy định quản lý trật tự đô thị...', tags: ['trật tự đô thị', 'xây dựng', 'xử phạt'] },
  { id: 'vb-02', category: 'van-ban', title: 'Thông Tư Hướng Dẫn Thực Hiện Dân Chủ Cơ Sở', author: 'Bộ Nội vụ', cover: 'https://images.unsplash.com/photo-1521791136064-798e00764aa2?auto=format&fit=crop&w=600&q=80', description: 'Quy chế thực hiện dân chủ ở xã, phường, thị trấn và quyền tham gia của người dân vào hoạt động quản lý nhà nước.', downloads: 3420, featured: false, docType: 'Văn bản pháp luật', issuingAgency: 'Bộ Nội vụ', issuedDate: '10/04/2025', effectiveDate: '01/06/2025', status: 'Đang hiệu lực', content: 'Nội dung chi tiết về thực hiện dân chủ cơ sở...', tags: ['dân chủ', 'cơ sở', 'quyền dân sự'] },
  { id: 'vb-03', category: 'van-ban', title: 'Nghị Định Về Xử Phạt Vi Phạm Hành Chính Trong Lĩnh Vực Đất Đai', author: 'Chính phủ', cover: 'https://images.unsplash.com/photo-1506905925349-8f15edf6c2e9?auto=format&fit=crop&w=600&q=80', description: 'Quy định mức phạt và biện pháp khắc phục đối với các hành vi vi phạm hành chính về đất đai.', downloads: 7890, featured: false, docType: 'Văn bản pháp luật', issuingAgency: 'Chính phủ', issuedDate: '20/03/2025', effectiveDate: '15/05/2025', status: 'Đang hiệu lực', content: 'Nội dung chi tiết về xử phạt vi phạm đất đai...', tags: ['đất đai', 'xử phạt', 'vi phạm'] },
  { id: 'vb-04', category: 'van-ban', title: 'Quyết Định Ban Hành Quy Chế Tiếp Công Dân Tại UBND Phường', author: 'UBND Phường Tăng Nhơn Phú', cover: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?auto=format&fit=crop&w=600&q=80', description: 'Quy trình, thời gian và trách nhiệm tiếp nhận, xử lý kiến nghị của công dân tại trụ sở UBND phường.', downloads: 4560, featured: false, docType: 'Văn bản pháp luật', issuingAgency: 'UBND Phường Tăng Nhơn Phú', issuedDate: '01/01/2025', effectiveDate: '15/01/2025', status: 'Đang hiệu lực', content: 'Nội dung chi tiết về quy chế tiếp công dân...', tags: ['tiếp dân', 'quy chế', 'khiếu nại'] },
  ...
  { id: 'vb-06', category: 'van-ban', title: 'Nghị Định 144/2021/NĐ-CP Về Xử Phạt An Ninh Trật Tự', author: 'Chính phủ', cover: 'https://images.unsplash.com/photo-1557597774-9d27360531a1?auto=format&fit=crop&w=600&q=80', description: 'Quy định xử phạt vi phạm hành chính trong lĩnh vực an ninh, trật tự, an toàn xã hội.', downloads: 9870, featured: false, docType: 'Văn bản pháp luật', issuingAgency: 'Chính phủ', issuedDate: '31/12/2021', effectiveDate: '01/02/2022', status: 'Đang hiệu lực', content: 'Nội dung chi tiết về xử phạt an ninh trật tự...', tags: ['an ninh', 'trật tự', 'xử phạt'] },
  { id: 'vb-07', category: 'van-ban', title: 'Luật Hôn Nhân Và Gia Đình 2014 (Trích Yếu)', author: 'Quốc hội', cover: 'https://images.unsplash.com/photo-1511285560929-80b4d4f8bd3a?auto=format&fit=crop&w=600&q=80', description: 'Trích yếu các điều khoản quan trọng về kết hôn, ly hôn, quyền và nghĩa vụ của vợ chồng.', downloads: 8900, featured: false, docType: 'Văn bản pháp luật', issuingAgency: 'Quốc hội', issuedDate: '19/06/2014', effectiveDate: '01/01/2015', status: 'Đang hiệu lực', content: 'Trích yếu Luật Hôn nhân và Gia đình...', tags: ['hôn nhân', 'gia đình', 'quyền lợi'] },

  { id: 'bd-01', category: 'ban-do', title: 'Bản Đồ Di Tích Lịch Sử Phường Tăng Nhơn Phú', author: 'Ban Văn hóa', cover: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=600&q=80', description: 'Bản đồ chi tiết vị trí các di tích lịch sử, văn hóa được công nhận trên địa bàn phường.', downloads: 12300, featured: true, docType: 'Bản đồ', tags: ['di tích', 'lịch sử', 'bản đồ'] },
