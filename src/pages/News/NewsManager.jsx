  ...
  const columns = [
    {
      ...
      render: (value, record, index) => (
        <span className="text-sm text-gray-900 max-w-[100px] truncate text-ellipsis overflow-hidden whitespace-nowrap">
    ...
    },
    {
      ...
      width: '200px',
      render: (danhMuc) => (
        <span className="block max-w-[200px] truncate text-ellipsis overflow-hidden whitespace-nowrap text-sm text-gray-700"
          title={danhMuc?.ten_danh_muc || 'Chưa phân loại'}>
    ...
    },
    {
      ...
      width: '150px',
      render: (value) => (
        <span className="block max-w-[150px] truncate text-ellipsis overflow-hidden whitespace-nowrap text-sm text-gray-700"
          title={value || 'N/A'}
        >
          {value || 'N/A'}
        </span>
    ...
    },
    {
      ...
      width: '100px',
      render: (value) => (
        <span className="block max-w-[100px] truncate text-ellipsis overflow-hidden whitespace-nowrap text-sm text-gray-700"
          title={value?.tin_tuc_view}>{value?.tin_tuc_view}</span>
      )
    },
    {
      title: 'Ngày tạo',
      ...
      width: '150px',
      render: (value) => (
        <span className="block max-w-[150px] truncate text-ellipsis overflow-hidden whitespace-nowrap text-sm text-gray-600">
